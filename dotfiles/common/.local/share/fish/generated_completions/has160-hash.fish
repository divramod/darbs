...
complete -c has160-hash -l crc32c --description 'CRC32C: calculate and print CRC32C hash sum.'
...
complete -c has160-hash -s G -l gost12-256 --description 'GOST-2012: calculate and print 256-bit GOST R 34.'
complete -c has160-hash -l gost12-512 --description 'GOST-2012: calculate and print 512-bit GOST R 34.'
complete -c has160-hash -l gost94 --description 'GOST-94: calculate and print GOST R 34.'
complete -c has160-hash -l gost94-cryptopro --description 'GOST-94-CRYPTOPRO: calculate and print CryptoPro version of the deprecated Ru…'
...
complete -c has160-hash -s m -l message --description 'Calculate hash sums of the text message.'
...
complete -c has160-hash -s g -l magnet --description 'Print hash sums formatted as magnet links.'
