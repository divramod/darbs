...
# DEFAULTS:
# TODO [ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/divramod/darbs.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/divramod/darbs/master/rice/arch_manjaro_i3/progs.csv"
...
goinstall() { \
	dialog --title "LARBS Installation" --infobox "Installing the npm-package \`$1\` ($n of $total). $1 $2" 5 70
  command -v go || pacman -S --noconfirm --needed go >/dev/null 2>&1
...
# TODO putgitrepo "$dotfilesrepo" "/home/$name"
# TODO rm "/home/$name/README.md" "/home/$name/LICENSE"

# Install the LARBS Firefox profile in ~/.mozilla/firefox/
# TODO putgitrepo "https://github.com/LukeSmithxyz/mozillarbs.git" "/home/$name/.mozilla/firefox"

# Pulseaudio, if/when initially installed, often needs a restart to work immediately.
[ -f /usr/bin/pulseaudio ] && resetpulse

# Install vim `plugged` plugins.
# TODO dialog --infobox "Installing (neo)vim plugins..." 4 50
# TODO (sleep 30 && killall nvim) &
# TODO sudo -u "$name" nvim -E -c "PlugUpdate|visual|q|q" >/dev/null 2>&1
