...
complete -c ansible-playbook -l ask-su-pass --description 'ask for su password (deprecated, use become).'
complete -c ansible-playbook -l ask-sudo-pass --description 'ask for sudo password (deprecated, use become).'
complete -c ansible-playbook -l ask-vault-pass --description 'ask for vault password.'
complete -c ansible-playbook -l become-method --description 'privilege escalation method to use (default=sudo), valid choices: [ sudo | su…'
...
complete -c ansible-playbook -l version --description 'show program\'s version number and exit.'
...
complete -c ansible-playbook -s M -l module-path --description 'prepend colon-separated path(s) to module library (default=[u\'/home/jenkins/.'
complete -c ansible-playbook -s R -l su-user --description 'run operations with su as this user (default=None) (deprecated, use become).'
...
complete -c ansible-playbook -s U -l sudo-user --description 'desired sudo user (default=root) (deprecated, use become).'
...
complete -c ansible-playbook -s s -l sudo --description 'run operations with sudo (nopasswd) (deprecated, use become).'
