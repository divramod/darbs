...
complete -c inxi -s w -l weather --description 'Adds weather line.'
...
complete -c inxi -l output --description 'Change data output type.  Requires --output-file if not fBscreen.'
