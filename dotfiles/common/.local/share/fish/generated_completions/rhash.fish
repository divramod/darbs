...
complete -c rhash -l crc32c --description 'CRC32C: calculate and print CRC32C hash sum.'
...
complete -c rhash -s G -l gost12-256 --description 'GOST-2012: calculate and print 256-bit GOST R 34.'
complete -c rhash -l gost12-512 --description 'GOST-2012: calculate and print 512-bit GOST R 34.'
complete -c rhash -l gost94 --description 'GOST-94: calculate and print GOST R 34.'
complete -c rhash -l gost94-cryptopro --description 'GOST-94-CRYPTOPRO: calculate and print CryptoPro version of the deprecated Ru…'
...
complete -c rhash -s m -l message --description 'Calculate hash sums of the text message.'
...
complete -c rhash -s g -l magnet --description 'Print hash sums formatted as magnet links.'
